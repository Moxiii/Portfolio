...
const SlideInfiniteCarousel = lazy(() => import("../../Components/Carrousel/SlideInfiniteCarousel/SlideInfiniteCarousel.tsx"))
                    ...
                    <DragCloseDrawer isOpen={dragCloseDrawerOpen} setIsOpen={setDragCloseDrawerOpen}>
                        <div className={s.ProjectPresContainer}>
                            ...
                            <div className={s.ProjecImgContainer}>
                                {openedProject.img && <SlideInfiniteCarousel images={openedProject.img}/>}
                            </div>
                    ...
                    <div className={s.contactFormContainer}>
                        <form ref={emailRef} onSubmit={(e) => SendEmail(e, emailRef)} className={s.ContactForm}>
                            <input type="email" name="user_email" placeholder="Votre Email"
                                   className={cn(s.ContactInput, "email")}/>
                            <input type="text" name="user_subject" placeholder="Sujet"
                                   className={cn(s.ContactInput, "subject")}/>
                            <textarea name="user_message" placeholder="Votre Message"
                                      className={cn(s.ContactInput, "message")}></textarea>
