...
export default function About(): JSX.Element {
    ...
    const interests = [
        {
            ...
            content: <div className="tilt-card-content">
                ...
                <p>NEO ERGO</p>
                <ul>
                    <li>- Durock white lotus</li>
                    <li>- Keycap BOW aliexpress</li>
                </ul>
        ...
        },
        {
            ...
            content: <div className="tilt-card-content">
                ...
                <p>Ce qui a motiver la creation de "Hera" pour faire un outils de recherche pour vetements de
                    'collection'</p>
            </div>,
            icon: faShirt,
        },
    ...
    const sideSkills = [
        ...
        {
            title: "Android",
            text: "Application Android de gestion en cour \n pour plus de détails voir le projet LYRA ."
        },
    ...
    return (
        <>
            ...
            <div className="about-page">
                ...
                <section className="text-zone" style={{
                    "--background-color": roseMagenta,
                    ...
                    <div className="first-pres">
                        ...
                        <div className="text-container">
                            <p>
                                A 5 ans la premiere manette de NES dans les mains , 8 ans plus tard je découvre la
                                programmation avec
                                python .
                            </p>
                            <p>Malheureusement en manque d'idée il aura fallu attendre encore quasiment 10 ans pour que
                                je me relance
                ...
                <section className=" cv-section" style={{"--background-color": roseMagenta} as React.CSSProperties}>
                    ...
                    <a href={CV as string} download="CV Maxime Lapouge" rel="noopener noreferrer">
                        <button className="cv-button"> Télecharger le cv</button>
                    </a>
                </section>
            </div>
        </>
