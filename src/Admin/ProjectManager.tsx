...
import {addProject , getProjects, deleteProject , updateProject} from "../Database/Init.ts"
...
export default function ProjectManager():JSX.Element{
    ...
    async function handleUpdateProject(id:number , updatedData: Partial<{ title: string; description: string; image: string }>){
        await updateProject(id , updatedData);
        loadProjects();
    }
    function handleAddTechno(e:React.ChangeEvent<HTMLInputElement> , index:number){
    ...
    function handleAddLinks(e:React.ChangeEvent<HTMLInputElement> , index:number){
