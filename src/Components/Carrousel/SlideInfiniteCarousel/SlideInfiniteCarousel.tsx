import s from "./SlideInfiniteCarousel.module.scss"
...
interface SlideInfiniteCarouselProps {
    images: ImageData[];
}

export default function SlideInfiniteCarousel({images}: SlideInfiniteCarouselProps): JSX.Element {
